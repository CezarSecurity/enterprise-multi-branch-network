...
IEEE 802.1Q trunking is used between distribution and access switches.

Security enhancements include:

- Native VLAN hardening
- Explicit allowed VLAN lists
- Dynamic Trunking Protocol (DTP) disabled
- Standardized trunk configuration across all sites
